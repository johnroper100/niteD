...
if (isset($_POST['projectcreate'])) {
    ...
    $sql4 = "CREATE TABLE IF NOT EXISTS `tasks` (`task_id` int NOT NULL PRIMARY KEY AUTO_INCREMENT, `task_name` varchar(50) NOT NULL, `task_desc` text NOT NULL, `task_state` varchar(20) NOT NULL, `task_media_type` varchar(20) NOT NULL, `task_media` text NOT NULL, `task_assigned` varchar(50) NOT NULL, UNIQUE KEY `task_id` (`task_id`))";
